...
import 'package:stu_teach/features/auth/presentation/pages/login/part/teacher_register_bottom_sheet.dart';
      ...
      child: BlocConsumer<AuthCubit, AuthState>(
        listener: (context, state) {
          ...
          if (state is AuthErrorState) {
            customDialog(context, 'User not found or Check Internet', state.message, AppIcons.icError);
          }
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: CustomButton(
                                  ...
                                  onTap: () {
                                    teacherRegisterBottomSheet(context: context,bloc: bloc);
                                  },
                                ),
                              ),
